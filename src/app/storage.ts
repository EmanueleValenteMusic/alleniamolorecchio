  ...
  try {
    ...
    return {
      ...
      scaleFamily: parsed.scaleFamily === 'minore naturale' || parsed.scaleFamily === 'minore armonica' || parsed.scaleFamily === 'minore melodica'
        ? parsed.scaleFamily
        : 'maggiore',
      playMode: parsed.playMode === 'intervalli' || parsed.playMode === 'altezza' || parsed.playMode === 'durata' || parsed.playMode === 'intensita' || parsed.playMode === 'quadriadi' || parsed.playMode === 'nota singola' ? parsed.playMode : 'triadi',
